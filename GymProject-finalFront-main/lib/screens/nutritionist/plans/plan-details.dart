...
class PlanDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    for (Map<String, Object> set in _group['sets'] as Iterable) {
      print(set['title']);
        ...
        children: <Widget>[
          ListView(
            ...
            children: <Widget>[
              ...
              for (Map<String, Object> exercise in _group['exercises'] as Iterable)
                CustomListTileNoTrailing(
                  exercise['title'] as String,
                  [
                    formatDuration(exercise['duration']as String),
