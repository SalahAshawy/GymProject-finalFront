...
class ClassesServices {
  ...
  static void addClass({
    ...
    http
        .post(Uri.parse('$local/api/classes/store'),
      ...
      if (data['status'] == true) {
        ...
        if (Global.role == 'coach')
          coachCubit.update();
        else
          adminCubit.addClassesSuccess();
      } else {
  ...
  static void updateClass({
    ...
    createCubit.loading1();
    http
        .put(Uri.parse('$local/api/classes/update/$id'),
            headers: <String, String>{
              'Content-Type': 'application/json',
              'Access-Control-Allow-Methods': 'GET, POST, PUT, PATCH, DELETE',
              'Access-Control-Allow-Headers': 'Content-Type, Authorization',
  ...
  static void attachMembersToClass({
    ...
    createCubit.loading1();
    http
        .post(Uri.parse('$local/api/classes/assignMember/${classes.id}'),
            headers: <String, String>{
              'Content-Type': 'application/json',
              'Access-Control-Allow-Methods': 'GET, POST, PUT, PATCH, DELETE',
              'Access-Control-Allow-Headers': 'Content-Type, Authorization',
  ...
  static void attachCoachToClass({
    ...
    createCubit.loading1();
    http
        .post(Uri.parse('$local/api/classes/assignCoach/${classes.id}'),
            headers: <String, String>{
              'Content-Type': 'application/json',
              'Access-Control-Allow-Methods': 'GET, POST, PUT, PATCH, DELETE',
              'Access-Control-Allow-Headers': 'Content-Type, Authorization',
